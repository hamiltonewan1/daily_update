### Script to get the metal song to be displayed in the app. 
import requests
import webbrowser


# Log into Reddit API and extract data from r/metalcore
...
res = requests.get("https://oauth.reddit.com/r/metalcore/hot",
                   headers=headers)
